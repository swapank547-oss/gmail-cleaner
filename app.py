...
def oauth2callback():
    ...
    if error:
        return render_template("index.html", authenticated=False, error=f"Google denied access: {error}")
        ...
        try:
            ...
            for cat in categories:
                ...
                _tasks[tid] = {
                    ...
                    "current": cat, "overall_total": overall,
                }
            ...
            _tasks[tid] = {
                "status": "error", "categories": results if 'results' in dir() else {},
